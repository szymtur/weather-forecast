...
class CurrentIcon extends React.Component {
    render(){
        ...
        const selectIcon = (id, icon) =>{
            ...
            if(id == 800 && icon.charAt(2) == 'd'){
                return html = <i className="wi wi-day-sunny" />
            }
            else if(id == 800 && icon.charAt(2) == 'n'){
                return html = <i className="wi wi-night-clear" />
            }
            else if(id == 801 && icon.charAt(2) == 'd'){
                return html = <i className="wi wi-day-cloudy" />
            }
            else if(id == 801 && icon.charAt(2) == 'n'){
                return html = <i className="wi wi-night-cloudy" />
            }
            else if(id == 802 && icon.charAt(2) == 'd'){
                return html = <i className="wi wi-day-cloudy" />
            }
            else if(id == 802 && icon.charAt(2) == 'n'){
                return html = <i className="wi wi-night-cloudy" />
            }
            else if(id == 803 && icon.charAt(2) == 'd'){
                return html = <i className="wi wi-day-cloudy-high" />
            }
            else if(id == 803 && icon.charAt(2) == 'n'){
                return html = <i className="wi wi-night-cloudy-high" />
            }
            else if(id == 804 && icon.charAt(2) == 'd'){
                return html = <i className="wi wi-day-cloudy-high" />
            }
            else if(id == 804 && icon.charAt(2) == 'n'){
                return html = <i className="wi wi-night-cloudy-high" />
            }
            else if(id >=701 && id <= 781 && icon.charAt(2) == 'd'){
                return html = <i className="wi wi-day-fog" />
            }
            else if(id >=701 && id <= 781 && icon.charAt(2) == 'n'){
                return html = <i className="wi wi-night-fog" />
            }
            else if(id >=600 && id <= 622 && icon.charAt(2) == 'd'){
                return html = <i className="wi wi-day-snow" />
            }
            else if(id >=600 && id <= 622 && icon.charAt(2) == 'n'){
                return html = <i className="wi wi-night-snow" />
            }
            else if(id == 511 && icon.charAt(2) == 'd'){
                return html = <i className="wi wi-day-snow" />
            }
            else if(id == 511 && icon.charAt(2) == 'n'){
                return html = <i className="wi wi-night-snow" />
            }
            else if(id >=500 && id <= 504 && icon.charAt(2) == 'd'){
                return html = <i className="wi wi-day-showers" />
            }
            else if(id >=500 && id <= 504 && icon.charAt(2) == 'n'){
                return html = <i className="wi wi-night-showers" />
            }
            else if(id >=520 && id <= 531 && icon.charAt(2) == 'd'){
                return html = <i className="wi wi-day-rain" />
            }
            else if(id >=520 && id <= 531 && icon.charAt(2) == 'n'){
                return html = <i className="wi wi-night-rain" />
            }
            else if(id >=300 && id <= 321 && icon.charAt(2) == 'd'){
                return html = <i className="wi wi-day-rain" />
            }
            else if(id >=300 && id <= 321 && icon.charAt(2) == 'n'){
                return html = <i className="wi wi-night-rain" />
            }
            else if(id >=200 && id <= 232 && icon.charAt(2) == 'd'){
                return html = <i className="wi wi-day-thunderstorm" />
            }
            else if(id >=200 && id <= 232 && icon.charAt(2) == 'n'){
